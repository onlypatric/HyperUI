...
public class HCheckBox extends JCheckBox { 
    ...
    public HCheckBox(Options options) {
        super();
        this.options = options;
        loadOptions();
    }

    public HCheckBox setClasses(String[] classes) {
    ...
    private void loadOptions(Options customOptions) {
        if (customOptions != null) {
            ...
            if (customOptions.getItemListener() != null)
                addItemListener(customOptions.getItemListener());
            if (customOptions.getMouseMotionListener() != null)
                addMouseMotionListener(customOptions.getMouseMotionListener());
        }
    }
    public HCheckBox addID(String ID) {
